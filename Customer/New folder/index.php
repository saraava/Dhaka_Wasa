...
<div id="wrap">
			...
			<div id="header" style="margin: auto;width: 60%; background">			
            <div id="header-links" >	
                <p id="logo-text">
                    <a href="https://dwasa.org.bd/"><img src="../img/wasa_logo.jpg" style="width:120px;height:128px"></a>
                    <img  src="../img/wasa_text.gif" style="width:400px;height:64px" >
                </p>		
                <p>
							</p>		
		      </div>		
