...
<html>
	...
	<div class="wrapper">
		...
		<p>Please fill in Name in uppercase letter</p>
...
<?php
		...
		$sql = oci_parse($conn,"create or replace view customer_info as select cust_name, cust_houseno, cust_roadno, cust_sector , cust_area  from customer ");
		if (!$sql)
			{
			  echo "error";
			}
        ...
        $sql = oci_parse($conn,"SELECT * FROM customer_info where upper(cust_name)='$name'");
        if(! $sql )
        {
        echo "error";
        }
