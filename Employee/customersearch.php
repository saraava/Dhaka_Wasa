...
<html>
	...
	<div class="wrapper">
		...
		<p>Please fill in area in uppercase letter</p>
...
<?php
        ...
        $sql = oci_parse($conn,"SELECT * FROM customer_info where upper(cust_area)='$area' or upper(cust_city)='$area' or upper(cust_name)='$area' ");
        if(! $sql )
        {
        echo "error";
        }
